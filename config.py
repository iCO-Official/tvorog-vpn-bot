...
# Тексты сообщений
WELCOME_TEXT = """
<b>Привет! Это Творог VPN — сервис, который просто работает.</b>

Быстро, стабильно, без рекламы и заморочек.

<b>Что умеет бот:</b>
⚡ Ускорение загрузки сообщений, фото и видео
📞 Стабильные звонки и видеосвязь без лагов
🎮 Высокая скорость для стримов и онлайн-игр
🔒 Надёжное и стабильное соединение
📱 До 3 устройств на одну подписку
🎁 3 дня бесплатно — без привязки карты

Нажмите «Моя подписка», чтобы начать!
"""
